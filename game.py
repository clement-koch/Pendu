...
def print_settings() :
    ...
    txt_var_difficulty = font_title.render(list_difficulty[difficulty-1],1,(0, 0, 0))
    ...
    screen.blit(pygame.transform.scale(pygame.image.load('assets/images/papier.png'), (300, 35)), (325, 285)) # barre de saisie de texte

    # clignotement de la barre de positionnement du texte
...
while running :
    ...
    if start :
        ...
        if game_status == 'defaite' :
            ...
            #print("défaite")
            # ajouter la fenêtre de défaite
        elif game_status == 'victoire' :
            #print("victoire")
            print("")


             #changer le visage de la lune en fonction des vies
